...
## 2026-07-24
- Relocate the WAF reference material to `.github/ai-reference/waf/` so
  pkgdown clean builds cannot delete hand-maintained AI guidance.
...
- Initial scaffold: lightweight `copilot-instructions.md` (think-then-code
  ...
  template — omits `/spec`, `/plan` prompts and `Architect`/`Planner` agents
  by design. Use when formal spec overhead is not warranted (exploratory work,
